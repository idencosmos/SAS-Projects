...
model v21=x3 v19 v15 v24 x16 M01 M02 v100 v101 v102 v103 v104 v105 v22 OFFC_NM/selection=none showpvalues stats=all;
where v19^=. and v21^=. and v7^=.;
run;

proc glmselect data=&lib..M02;
class v22(ref="일반회계") OFFC_NM x31(ref="0");
model v21=x31 v19 v15 v24 x16 M01 M02 v100 v101 v102 v103 v104 v105 v22 OFFC_NM/selection=none showpvalues stats=all;
where v19^=. and v21^=. and v7^=.;
run;

proc glmselect data=&lib..M02;
class v22(ref="일반회계") OFFC_NM x4(ref="0");
model v21=x4 v19 v15 v24 x16 M01 M02 v100 v101 v102 v103 v104 v105 v22 OFFC_NM/selection=none showpvalues stats=all;
where v19^=. and v21^=. and v7^=.;
run;
...
model v21=x5 v19 v15 v24 x16 M01 M02 v100 v101 v102 v103 v104 v105 v22 OFFC_NM/selection=none showpvalues stats=all;
where v7^=0 and v7^=.;
run;

proc glmselect data=&lib..M02;
class v22(ref="일반회계") OFFC_NM;
model v21=v7 v19 v15 v24 x16 M01 M02 v100 v101 v102 v103 v104 v105 v22 OFFC_NM/selection=none showpvalues stats=all;
where v7<0;
run;
