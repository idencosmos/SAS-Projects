...
%json(String05=http://openapi.openfiscaldata.go.kr/ExpenditureBudgetInit1, date_s=2007, date_e=2019);
...
, input(Y_YY_MEDI_KCUR_AMT, best32.) as Y_YY_MEDI_KCUR_AMT label="금년도조정원화금액"
, input(Y_YY_DFN_MEDI_KCUR_AMT, best32.) as Y_YY_DFN_MEDI_KCUR_AMT label="금년도확정조정원화금액"
from combine;
quit;
run;
