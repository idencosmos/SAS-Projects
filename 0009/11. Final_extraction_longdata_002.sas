...
%json(String05=http://openapi.openfiscaldata.go.kr/ExpendituresSettlement, date_s=2007, date_e=2019);

/*변수명, 변수 형태 변경_start*/
data combine;
set L001_2007-L001_2019;
keep &var_want;
...
, input(OFFC_CD, best32.) as OFFC_CD label="소관"
, OFFC_NM as OFFC_NM label="소관명"
, input(FSCL_CD, best32.) as FSCL_CD label="회계"
, FSCL_NM as FSCL_NM label="회계명"
, input(ACCT_CD, best32.) as ACCT_CD label="계정"
, ACCT_NM as ACCT_NM label="계정명"
, input(FLD_CD, best32.) as FLD_CD label="분야"
, FLD_NM as FLD_NM label="분야명"
, input(SECT_CD, best32.) as SECT_CD label="부문"
, SECT_NM as SECT_NM label="부문명"
, input(PGM_CD, best32.) as PGM_CD label="프로그램"
, PGM_NM as PGM_NM label="프로그램명"
, input(ACTV_CD, best32.) as ACTV_CD label="단위사업"
, ACTV_NM as ACTV_NM label="단위사업명"
, input(CITM_CD, best32.) as CITM_CD label="지출목"
